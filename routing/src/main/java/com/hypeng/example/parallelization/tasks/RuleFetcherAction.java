...
import com.hypeng.example.parallelization.exceptions.ActionFailedException;
...
public class RuleFetcherAction implements Action {
    ...
    private static final Logger LOGGER = Logger.getLogger(RuleFetcherAction.class.getName());
